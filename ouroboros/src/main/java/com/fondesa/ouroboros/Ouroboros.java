...
import com.fondesa.ouroboros.field.FieldsRetriever;
 ...
 * All basic types will be resolved through basic coders contained in the package {@link com.fondesa.ouroboros.coder.base}.
 ...
 * they use {@link Ouroboros}) will save and restore the state of that field.
 * <br>
 * This class uses the singleton pattern so you must initialize it once using the provided {@link Builder}.
 * After, you can access to instance methods with {@link Ouroboros#instance()}.
 */
public class Ouroboros {
    private static final String TAG = Ouroboros.class.getSimpleName();
    ...
    private static Ouroboros instance;

    /**
     * Creates a {@link Builder} instance to specify {@link Ouroboros}'s configurations.
     *
     * @param application {@link Application}'s instance used to create the {@link Builder}
     * @return a new {@link Builder} to generate the singleton instance of {@link Ouroboros}
     */
    public static Builder with(@NonNull Application application) {
        return new Ouroboros.Builder().with(application);
    }
    ...
    /**
     * Check if the singleton instance of {@link Ouroboros} is initialized.
     *
    ...
    /**
     * Get the singleton instance of {@link Ouroboros} if it's initialized.
     *
     * @return not null instance of {@link Ouroboros}
     */
    ...
    public void saveState(@NonNull Object stateHolder, @NonNull Bundle state) {
        ...
        final Ouroboros ouroboros = instance();
        Field[] fields = ouroboros.mFieldsRetriever.getFields(stateHolder.getClass());
        ...
        for (int i = 0; i < fields.length; i++) {
            ...
            if (fieldValue != null) {
                ...
                try {
                    stateCoder = ouroboros.mCoderRetriever.getCoder(saveState, field.getType());
    ...
    @SuppressLint("NewApi")
    private Ouroboros(@NonNull Application application,
            ...
            if (Build.VERSION.SDK_INT >= neededApi) {
                ...
                AutomaticSaveStateManager.Listener listener = new AutomaticSaveStateManager.Listener() {
                    ...
                    public void onSaveState(@NonNull Activity activity, @NonNull Bundle outState) {
                        Ouroboros.instance().saveState(activity, outState);
                    }

                    @Override
                    public void onRestoreState(@NonNull Activity activity, @Nullable Bundle savedState) {
                        Ouroboros.instance().restoreState(activity, savedState);
                    }
                };
    ...
    /**
     * Builder class used to create the singleton instance of {@link Ouroboros}.
     * <br>
     * To create a new instance of this {@link Builder} use {@link Ouroboros#with(Application)}.
     */
    public static final class Builder {
         ...
         * An instance of {@link AutomaticSaveStateManager} will be attached to the {@link Ouroboros} to manage
        ...
        /**
         * Creates an instance of {@link Ouroboros} with the previously specified {@link Builder}'s
        ...
        public void build() {
            ...
            instance = new Ouroboros(mApplication, mCoderRetriever, mFieldsRetriever, mAutoSaveActivities);
        }
    }
}