...
/**
 * Implementation of {@link StateCoder} to manage {@code Parcelable array} fields.
 */
public class ParcelableArrayCoder extends BaseCoder<Parcelable[]> {
    ...
    public void serialize(@NonNull Bundle state, @NonNull String key, @NonNull Parcelable[] fieldValue) {
        state.putParcelableArray(key, fieldValue);
    }
}