...
/**
 * Implementation of {@link StateCoder} to manage {@code short array} fields.
 */
public class ShortArrayCoder extends BaseCoder<short[]> {
     ...
     */
    @Override
    public void serialize(@NonNull Bundle state, @NonNull String key, @NonNull short[] fieldValue) {
        state.putShortArray(key, fieldValue);
    }
}