...
/**
 * Implementation of {@link StateCoder} to manage {@code int array} fields.
 */
public class IntArrayCoder extends BaseCoder<int[]> {
     ...
     */
    @Override
    public void serialize(@NonNull Bundle state, @NonNull String key, @NonNull int[] fieldValue) {
        state.putIntArray(key, fieldValue);
    }
}